          ...
          {eventos.length > 0 ? (
            <div className="ordenacao-meus-eventos">
              ...
              <div 
                ...
                title={ordemCrescente ? 'Ordenar de forma crescente' : 'Ordenar de forma decrescente'}
              ...
              > 
                ...
                <Select textoPadrao='Ordenar por' value={criterioOrdenacao} name='ordenacao' onChange={(e:any) => setCriterioOrdenacao(e.target.value)}>
              ...
              <div className='container'>
                <div className='row g-5'>
                  {eventosClassificados.emAndamento.map((evento) => (
                      <div className='col-12 col-sm-12 col-md-6 col-lg-6 col-xl-4 col-xxl-4' key={evento.idEvento}>
                        <CardEvento 
                          key={evento.idEvento}
            ...
            <div onClick={() => navigate('/criar-evento')} className="botao-criar-eventos">
                <div className='botao-criar-eventos-meus-eventos' title='Criar evento'>
                  <svg xmlns="http://www.w3.org/2000/svg" width="33" height="33" viewBox="0 0 33 33" fill="none">
                    <path d="M16.5001 6.59961L16.5001 26.3996M26.4001 16.4996L6.6001 16.4996" stroke="white" strokeWidth="3" strokeLinecap="round"/>
                  </svg>
                </div>
            </div>
          </div>
