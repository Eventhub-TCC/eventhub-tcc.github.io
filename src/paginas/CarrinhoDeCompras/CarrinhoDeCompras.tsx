            ...
            itens: [
                {
                    ...
                    unidade: 'unidade',
                    quantidade: 100,
                    instrucao: 'Instrução de uso do produto 1',
                ...
                },
                {
                    ...
                    unidade: 'unidade',
                    quantidade: 1,
                    instrucao: 'Instrução de uso do produto 2',
                    precoSemDesconto: 75.00
                }, 
                {
                    id: 3,
                    nome: 'Produto 3',
                    ...
                    unidade: 'unidade',
                    quantidade: 3,
                    instrucao: 'Instrução de uso do produto 3',
                    precoSemDesconto: 100.00
                }
            ]
        };
    const [carrinho, setCarrinho] = useState(carrinhoMocado);

  return (
    <div className='container-carrinho'>
        <div className='container-carrinho__titulo'>
            Carrinho de Compras
        </div>
        { carrinho.itens.length > 0 ? (
            <>
                    ...
                    {carrinho.itens.map((item) => (
                        <div className='container-carrinho-item'>
                            <div className='container-carrinho-item_info'>
                                <div className='container-carrinho-item-info__produto'>
                                    ...
                                    <div className='container-carrinho-item-info__produto-nome-preco'>
                                        <div className='container-carrinho-item-info__produto-nome'>{item.nome}</div>
                                        <div className='container-carrinho-item-info__produto-preco'>R$ {item.precoDesconto!.toFixed(2)} / {item.unidade} </div>
                                    ...
                                    <div className='container-carrinho-item-info__produto-quantidade'>
                                        <div className='container-carrinho-item-info__produto-quantidade-texto'>Quantidade</div>
                                        <div className='container-carrinho-item-info__produto-quantidade-mais-menos'>
                                            <div className='container-carrinho-item-info__produto-quantidade-mais-menos-botoes'>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="19" viewBox="0 0 18 19" fill="white">
                                                    <path d="M14.3996 9.5L3.59961 9.5" stroke="white" stroke-width="2" stroke-linecap="round"/>
                                                </svg>
                                            </div>
                                            <div className='container-carrinho-item-info__produto-quantidade-caixa'>
                                                <div className='container-carrinho-item-info__produto-quantidade-valor'>{item.quantidade}</div>
                                            </div>
                                            <div className='container-carrinho-item-info__produto-quantidade-mais-menos-botoes'>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="19" viewBox="0 0 18 19" fill="none">
                                                    <path d="M8.99961 4.09961L8.99961 14.8996M14.3996 9.49961L3.59961 9.49961" stroke="white" stroke-width="2" stroke-linecap="round"/>
                                                </svg>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className='container-carrinho-item-info__produto-preco-total'>
                                    <div className='container-carrinho-item-info__produto-preco-total-texto'>Preço total:</div>
                                    <div className='container-carrinho-item-info__produto-preco-total-desconto'>
                                        <div className='container-carrinho-item-info__produto-desconto-preco-sem-desconto'>
                                            ...
                                            {("-" + (Math.floor(((item.precoSemDesconto - item.precoDesconto) / item.precoSemDesconto * 100) * 100) % 100).toString().padStart(2, '0'))}%
                                            </div>
                                            <div className='container-carrinho-item-info__produto-preco-sem-desconto'>
                                                R$ {item.precoSemDesconto!.toFixed(2)}
                                            </div>
                                        </div>
                                        <div className='container-carrinho-item-info__produto-preco-total-valor'>R$ {(item.precoDesconto! * item.quantidade).toFixed(2)}</div>
                                    </div>  
                                </div>
                                <div className='container-carrinho-item-info__lixeira'>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="19" viewBox="0 0 16 19" fill="none">
                                        <g clip-path="url(#clip0_40739_1015)">
                                            <path d="M4.82857 1.12227C5.02143 0.739063 5.41786 0.5 5.85 0.5H10.15C10.5821 0.5 10.9786 0.739063 11.1714 1.12227L11.4286 1.625H14.8571C15.4893 1.625 16 2.12773 16 2.75C16 3.37227 15.4893 3.875 14.8571 3.875H1.14286C0.510714 3.875 0 3.37227 0 2.75C0 2.12773 0.510714 1.625 1.14286 1.625H4.57143L4.82857 1.12227ZM1.14286 5H14.8571V16.25C14.8571 17.491 13.8321 18.5 12.5714 18.5H3.42857C2.16786 18.5 1.14286 17.491 1.14286 16.25V5ZM4.57143 7.25C4.25714 7.25 4 7.50313 4 7.8125V15.6875C4 15.9969 4.25714 16.25 4.57143 16.25C4.88571 16.25 5.14286 15.9969 5.14286 15.6875V7.8125C5.14286 7.50313 4.88571 7.25 4.57143 7.25ZM8 7.25C7.68571 7.25 7.42857 7.50313 7.42857 7.8125V15.6875C7.42857 15.9969 7.68571 16.25 8 16.25C8.31429 16.25 8.57143 15.9969 8.57143 15.6875V7.8125C8.57143 7.50313 8.31429 7.25 8 7.25ZM11.4286 7.25C11.1143 7.25 10.8571 7.50313 10.8571 7.8125V15.6875C10.8571 15.9969 11.1143 16.25 11.4286 16.25C11.7429 16.25 12 15.9969 12 15.6875V7.8125C12 7.50313 11.7429 7.25 11.4286 7.25Z" fill="#6A40C3"/>
                                        </g>
                                        <defs>
                            ...
                            <div className='container-carrinho-item__checkbox'>
                                <Checkbox ativado={exibirInstrucoes} funcao={() => setExibirInstrucoes(!exibirInstrucoes)} texto='Incluir instrução para o prestador de serviços'></Checkbox>
                            </div>
                            {exibirInstrucoes ? 
                ...
                <div className='container-carrinho__total'>
                    TOTAL 
                    <div className='container-carrinho__total-valor'>R$ {carrinho.itens.reduce((total, item) => total + (item.precoDesconto! * item.quantidade), 0).toFixed(2)}</div>
                </div>
                <div className='container-carrinho__botao-finalizar'>
                    <div>
                        <Botao tamanho='max' cor='var(--purple-700)' texto='Finalizar pedido'/>
                    </div>
                </div>
            </>
        ) :
