  ...
  return (
    <div className='pedidos-container'>
      <div className='pedidos-titulo'>Meus Pedidos</div>
      {
        ...
        Object.keys(pedidosPorServico).length > 0 ? (
          Object.entries(pedidosPorServico).map(([servico, pedidos]) => (
            <TabelaPedido
              key={servico}
              titulo={servico}
              cor={'var(--yellow-800)'}
        ...
        <div className='pedidos__sem-pedidos'>
          <FeedbackFormulario
              titulo='Pedidos'
              texto='Aparentemente seus serviços ainda não foram solicitados.
                      Que tal divulgar mais serviços no nosso marketplace?'
              textoBotao='Ir para seus serviços'
