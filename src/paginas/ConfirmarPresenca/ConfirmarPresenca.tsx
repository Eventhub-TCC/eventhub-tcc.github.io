...
const ConfirmarPresenca = () => {
  ...
  return (
    <div>
    {
        conviteUtilizado ? 
        <>
            <div className="imagem-fundo-utilizado">
                ...
                <div className='informacoes-evento-convite'>
                    ...
                    <div className='dados-evento'>
                        ...
                        <div className='local-evento'>
                            ...
                            <div className='texto-local-evento'> {enderecoLocal ? `${enderecoLocal}, ${numeroLocal}, ${cidadeLocal} - ${ufLocal}` : 'Sem Local Definido'}  </div>
                        </div>
                    </div>
                </div>
                </div>
