...
const CabecalhoEvento = ({
    ...
    const [tipoEvento, setTipoEvento] = useState(tipoDoEvento)
      ...
      <div className="cabecalho-eventos">
        <div className='container'>
          <div className="titulo-infos-eventos">
            <div className="titulo-botoes">
              <div className="titulo-do-evento">
                <h1 className='layout-titulo'>{evento.nomeEvento}</h1>
              </div>
          ...
          <div className="abas-evento">
            <NavLink 
                to={`/meus-eventos/${evento.idEvento}/informacoes-meus-eventos`} 
                className={({isActive}: any) => (`aba-evento ${isActive ? "aba-evento--ativo" : ''}`)} >
                Informações Gerais
            </NavLink>
            <NavLink 
                to={`/meus-eventos/${evento.idEvento}/convidados`} 
                className={({isActive}: any) => (`aba-evento ${isActive ? "aba-evento--ativo" : ''}`)} >
                Convidados
            </NavLink>
            <NavLink 
                to={`/meus-eventos/${evento.idEvento}/convites`} 
                className={({isActive}: any) => (`aba-evento ${isActive ? "aba-evento--ativo" : ''}`)} >
                Convites
            </NavLink>
          </div>
                ...
                <div className='campos-editar-evento'>
                    <div className='nome-categoria-evento'>
                        <div className='nome-input-evento'>
                            ...
                            <div className="input-tamanho">
                                <Input value={eventoEditado?.nomeEvento || ""}  onChange={(e:any) => setEventoEditado((prev:any) =>
                    ...
                    <div className='descricao-input-evento'>
                        ...
                        <div className='input-tamanho-descricao'>
                            <Input value={eventoEditado?.descricaoEvento || ""}  onChange={(e:any) => setEventoEditado((prev:any) =>
                ...
                <div className='novos-dados-eventos'>
                    <div className='texto-input-data'>
                        ...
                        <div className='input-data-evento'>
                            <Input value={eventoEditado?.dataEvento || ""}  onChange={(e:any) => setEventoEditado((prev:any) =>
                    ...
                    <div className='texto-input-hora-inicio-evento'>
                        <div className='horario-inicio-fim-evento'>
                            ...
                            <div className='input-tamanho'>
                                <Input value={eventoEditado?.horaInicio || ""}  onChange={(e:any) => setEventoEditado((prev:any) =>
                    ...
                    <div className='input-texto-numero-complemento'>
                        <div className='input-texto-cep-numero'>
                            ...
                            <div className='input-tamanho-cep-numero'>
                                <Input value={eventoEditado?.numeroLocal || ""} onChange={(e:any) => setEventoEditado((prev:any) =>
                        ...
                        <div className='input-texto-endereco-complemento'>
                            ...
                            <div className='input-tamanho-endereco-complemento'>
                                <Input value={eventoEditado?.complementoLocal || ""}  onChange={(e:any) => setEventoEditado((prev:any) =>
                    ...
                    <div className='input-texto-bairro'>
                        ...
                        <div className='input-bairro'>
                            <Input disabled={travado}  value={eventoEditado?.bairroLocal || ""}  onChange={(e:any) => setEventoEditado((prev:any) =>
                    ...
                    <div className='input-texto-cidade-uf'>
                        <div className='input-cidade'>
                            ...
                            <div className='input-tamanho-cidade'>
                                <Input disabled={travado}  value={eventoEditado?.cidadeLocal || ""}  onChange={(e:any) => setEventoEditado((prev:any) =>
                        ...
                        <div className='input-uf'>
                            ...
                            <div className='input-tamanho-uf'>
                                <Input disabled={travado}  value={eventoEditado?.ufLocal || ""}  onChange={(e:any) => setEventoEditado((prev:any) =>
